...
const grouped = chapters.reduce<Record<ChapterType, Chapter[]>>(
    ...
    { react: [], ts: [], js: [] }
)`}),(0,n.jsx)(`hr`,{}),(0,n.jsx)(`h2`,{children:`initialValue очень важен`}),(0,n.jsx)(`p`,{children:`Если не передать его:`}),(0,n.jsx)(e,{code:`numbers.reduce((acc, num) => acc + num)
